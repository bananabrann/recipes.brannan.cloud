<div>
  <h1>Tempura Shrimp</h1>
  <img
    src="https://files.brannan.cloud/recipes/tempura-shrimp.png"
  ...
  <ul>
    ...
    <li>Cold water: 1 cup</li>
    <li>Egg: 1</li>
    <li>All-purpose flour: 1 cup</li>
    <li>2 cloves of garlic, minced</li>
    <li>Baking powder: 1 tsp (optional, for extra crispiness)</li>
    <li>Cornstarch: 2 tbsp (optional, helps make the batter crispy)</li>
    <li>Ice cubes: a handful (to keep the batter cold)</li>
    <li>Salt: to taste</li>
    <li>Oil: for deep frying, preferably vegetable or canola oil</li>
    <li>Dipping Sauce (optional):</li>
    <li>Soy sauce: 3 tbsp</li>
    <li>Mirin (sweet rice wine): 1 tbsp</li>
